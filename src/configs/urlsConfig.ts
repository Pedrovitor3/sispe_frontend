...
export const urlsServices = {
  ...
  SENDFILE: 'https://filews-h.ssp.go.gov.br/',
...
if (window.location.hostname.indexOf(domainNameProd) > -1) {
  ...
  urlsServices.BACKENDWS = 'https://cpesws.policiacivil.go.gov.br';
  ambiente = 'PROD';
} else {
  urlsServices.SIGUWS = 'https://cpesws-h.ssp.go.gov.br/';
  urlsServices.LEGADOWS = 'https://legadows-h.ssp.go.gov.br/';
  urlsServices.SSOWS = 'https://ssows-h.ssp.go.gov.br/';
  urlsServices.BACKENDWS = 'https://cpesws-homo.policiacivil.go.gov.br';
  ambiente = 'HOMO';
